...
![API](https://img.shields.io/badge/API-0.2.4--beta-orange)
...
The current release is **`0.2.4-beta`**. The numeric API version follows this
project policy:
...
- The API is version `0.2.4-beta` and may evolve before `1.0.0`.
