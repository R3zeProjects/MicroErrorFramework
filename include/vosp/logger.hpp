...
/** @file logger.hpp Logger policies, dispatch, and concrete sinks. */
...
namespace vosp::logger
{
    ...
    /** @brief Owning record exchanged between loggers and sinks. */
    struct LogEntry
    {
    ...
    /** @brief Runtime-polymorphic destination for one structured record. */
    class ILogSink
    {
    public:
    ...
    static_assert(vosp::contracts::LogSink<ILogSink, LogEntry>);
